...
static FuzzerBuilderRegister global_afl_register("aflfast", BuildAFLFastFuzzerFromArgs<Fuzzer, algorithm::aflfast::AFLFastFuzzer, executor::AFLExecutorInterface>);
